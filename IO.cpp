/***********************************************************************
 * File: IO.cpp
// Desc: Class for handling inpung and drawing, uses
 * SDL2.
***********************************************************************/
...
static uint32_t mColors[COLOR_MAX] = {0x000000ff, // Colors
...
======================================
*/
int IO::GetScreenHeight() { return mScreen->h; }
...
======================================
*/
void IO::UpdateScreen() { SDL_RenderPresent(mScreen); }
